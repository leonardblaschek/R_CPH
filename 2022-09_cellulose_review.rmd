...
velo_plot <- ggplot(velo_data,
  ...
  annotate("richtext",
           label = paste0("R<sup>2</sup> = ", rsq, " <i>(n.s.)</i>"),
           family = "Helvetica",
           size = ggtext_size,
           label.size = NA,
           y = 40,
...
velo_dist <- ggplot(
  ...
  geom_text(data = medians,
            ...
            hjust = 0) +
  annotate("richtext",
           label = "&mdash; <i>no significant differences</i> &mdash;",
           family = "Helvetica",
           size = ggtext_size,
           label.size = NA,
           fill = NA,
...
pdf("WT_velocities.pdf", width = onecol * 0.5, height = onecol * 0.5)
velo_dist
dev.off()
```
...
```{r}
pdf("Pedersen2022_figureS1.pdf", width = twocol, height = onecol * 0.75)
velo_plot + velo_dist +
