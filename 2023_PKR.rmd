...
table <- annotated_lines |>
  ...
  mutate(
    ...
    sterile_col = case_when(sterile == "🗸" ~ "#e8c245", TRUE ~ "grey"),
...
kable(
  ...
  column_spec(7, background = table$sterile_col) |>
  column_spec(8, background = table$pm_col) |>
  column_spec(9, background = table$wall_col) |>
  column_spec(1:9, border_left = "1px solid white") |>
